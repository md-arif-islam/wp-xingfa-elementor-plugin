...
class Elementor_CompanyNews_Widget extends \Elementor\Widget_Base {
	public function get_name() {
		return "XingfaCompanyNews";
	}

	public function get_title() {
		return __( "Company News • Xingfa", 'eletotallyunsigned' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => xingfa_get_categories( 'company_news-types' ),
				'default' => "",
			]
		);
